...
// Danh sách học sinh trường THPT Giồng Riềng trích xuất từ biểu mẫu số liệu
// Cấu trúc dạng bảng thu gọn tối ưu kích thước và tốc độ tải
interface RawRow {
  stt: number;
  classGroup: string;
  name: string;
...
const rawStudents: RawRow[] = [
  {
    stt: 3, classGroup: '10T4', name: 'Trương Kiều Tuấn Anh', dob: '22/01/2011', gender: 'Nam',
    ...
    birthPlace: 'Thành phố Rạch Giá, Kiên Giang', birthWard: 'Thành phố Rạch Giá, An Giang',
    homeTown: 'Xã Vĩnh Phú, Huyện Giồng Riềng, Kiên Giang', homeWard: 'Xã Long Thạnh, An Giang',
    fName: 'Trương Kiều Oanh', fJob: 'Lao động tự do', fYear: '1977', fPhone: '',
    mName: 'Phạm Thị Lai', mJob: 'Nội trợ', mYear: '1988', mPhone: '',
    sPhone: '', weight: '50', height: '155', swim: true, eyes: 'Bình thường', vneid: true
  },
  {
    stt: 4, classGroup: '10T4', name: 'Ngô Quốc Anh', dob: '13/01/2011', gender: 'Nam',
    ...
    birthPlace: 'Thị Trấn Giồng Riềng, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Giồng Riềng, An Giang',
  ...
  {
    stt: 5, classGroup: '10T4', name: 'Nguyễn Ngọc Trâm Anh', dob: '06/02/2011', gender: 'Nữ',
    ...
    birthPlace: 'Xã Ngọc Thành, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Ngọc Chúc, An Giang',
    homeTown: 'Xã Ngọc Thành, Huyện Giồng Riềng, Kiên Giang', homeWard: 'Xã Ngọc Chúc, An Giang',
    fName: 'Nguyễn Ngọc Diễn', fJob: 'Giáo Viên', fYear: 'Chưa cập nhật', fPhone: '0947711912',
    mName: 'Đặng Hồng Diềm', mJob: 'Giáo Viên', mYear: '', mPhone: '0844223709',
    sPhone: '0363636887', weight: '50', height: '160', swim: true, eyes: 'Cận thị', vneid: true
  },
  {
    stt: 6, classGroup: '10T4', name: 'Nguyễn Khánh Băng', dob: '22/08/2011', gender: 'Nữ',
  ...
  {
    stt: 7, classGroup: '10T4', name: 'Nguyễn Thị Ngọc Châu', dob: '03/10/2011', gender: 'Nữ',
    ...
    birthPlace: 'Xã Thạnh Phước, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Thạnh Hưng, An Giang',
  ...
  {
    stt: 8, classGroup: '10T4', name: 'Nguyễn Thành Danh', dob: '14/10/2011', gender: 'Nam',
  ...
  {
    stt: 9, classGroup: '10T4', name: 'Nguyễn Thị Mỹ Duyên', dob: '28/08/2011', gender: 'Nữ',
  ...
  {
    stt: 10, classGroup: '10T4', name: 'Trần Hồng Duyên', dob: '04/07/2011', gender: 'Nữ',
  ...
  {
    stt: 11, classGroup: '10T4', name: 'Thái Hạo Đông', dob: '02/05/2011', gender: 'Nam',
    cccd: '091211018063', issueDate: '15/10/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp Thạnh Đông', curWard: 'Xã Thạnh Hưng, An Giang',
    permHam: 'Ấp Thạnh Đông', permWard: 'Xã Thạnh Hưng, An Giang',
    birthPlace: 'Phường Phú Thứ, Quận Cái Răng, TP. Cần Thơ', birthWard: 'Phường Hưng Phú, TP. Cần Thơ',
  ...
  {
    stt: 12, classGroup: '10T4', name: 'Ngô Thị Hồng Hạnh', dob: '10/06/2011', gender: 'Nữ',
  ...
  {
    stt: 13, classGroup: '10T4', name: 'Lương Ngọc Khả Hân', dob: '14/11/2011', gender: 'Nữ',
  ...
  {
    stt: 14, classGroup: '10T4', name: 'Thạch Diệp Khánh Hân', dob: '01/09/2011', gender: 'Nữ',
    ...
    birthPlace: 'Xã Thạnh Hưng, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Thạnh Hưng, An Giang',
  ...
  {
    stt: 15, classGroup: '10T4', name: 'Phan Khải Hoàn', dob: '29/06/2011', gender: 'Nam',
    cccd: '092211000103', issueDate: '07/11/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp Thạnh Đông', curWard: 'Xã Thạnh Hưng, An Giang',
    permHam: 'Ấp Thạnh Đông', permWard: 'Xã Thạnh Hưng, An Giang',
    birthPlace: 'Thành Phố Cần Thơ', birthWard: 'TP. Cần Thơ',
  ...
  {
    stt: 16, classGroup: '10T4', name: 'Cam Vũ Huy', dob: '26/04/2011', gender: 'Nam',
  ...
  {
    stt: 17, classGroup: '10T4', name: 'Bùi Mỹ Huyền', dob: '07/09/2011', gender: 'Nữ',
  ...
  {
    stt: 18, classGroup: '10T4', name: 'Dương Gia Hưng', dob: '08/06/2011', gender: 'Nam',
  ...
  {
    stt: 19, classGroup: '10T4', name: 'Đào Mai Hương', dob: '26/01/2011', gender: 'Nữ',
  ...
  {
    stt: 20, classGroup: '10T4', name: 'Trương Nhật Khánh', dob: '26/08/2011', gender: 'Nam',
  ...
  {
    stt: 21, classGroup: '10T2', name: 'Lê Quốc Khôi', dob: '02/08/2011', gender: 'Nam',
  ...
  {
    stt: 22, classGroup: '10T4', name: 'Lê Đăng Khôi', dob: '14/12/2011', gender: 'Nam',
    cccd: '091211015276', issueDate: '15/10/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp Sáu Song', curWard: 'Xã Ngọc Chúc, An Giang',
    permHam: 'Ấp Kinh Xuôi', permWard: 'Xã Ngọc Chúc, An Giang',
    birthPlace: 'Xã Ngọc Chúc, Tỉnh Kiên Giang', birthWard: 'Xã Ngọc Chúc, An Giang',
    ...
    sPhone: '07866999024', weight: '48', height: '167', swim: true, eyes: 'Bình thường', vneid: true
  },
  {
    stt: 23, classGroup: '10T4', name: 'Trương Huỳnh Anh Khôi', dob: '10/11/2011', gender: 'Nam',
  ...
  {
    stt: 24, classGroup: '10T4', name: 'Nguyễn Ngọc Lam', dob: '18/06/2011', gender: 'Nữ',
  ...
  {
    stt: 25, classGroup: '10T4', name: 'Phan Trường Lâm', dob: '17/05/2011', gender: 'Nam',
    cccd: '091211013139', issueDate: '22/07/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp Thạnh Xuân', curWard: 'Xã Thạnh Hưng, An Giang',
    permHam: 'Ấp Thạnh Xuân', permWard: 'Xã Thạnh Hưng, An Giang',
    birthPlace: 'Rạch Giá An Giang', birthWard: 'Thành phố Rạch Giá, An Giang',
    homeTown: 'An Giang', homeWard: 'An Giang',
    fName: 'Phan Văn Nguyên', fJob: 'Kinh Doanh', fYear: 'Chưa cập nhật', fPhone: '0979654654',
  ...
  {
    stt: 26, classGroup: '10T4', name: 'Dương Tấn Lực', dob: '28/06/2011', gender: 'Nam',
  ...
  {
    stt: 27, classGroup: '10T4', name: 'Nguyễn Thị Thuyết Minh', dob: '19/06/2011', gender: 'Nữ',
    ...
    birthPlace: 'Phường Châu Văn Liêm, Quận Ô Môn, Thành phố Cần Thơ', birthWard: 'Phường Ô Môn, TP. Cần Thơ',
  ...
  {
    stt: 28, classGroup: '10T4', name: 'Phạm Lê Kim Ngân', dob: '21/02/2009', gender: 'Nữ',
  ...
  {
    stt: 29, classGroup: '10T4', name: 'Nguyễn Bảo Ngọc', dob: '04/12/2011', gender: 'Nữ',
  ...
  {
    stt: 30, classGroup: '10T4', name: 'Huỳnh Nguyễn Kim Nguyên', dob: '24/02/2011', gender: 'Nữ',
  ...
  {
    stt: 31, classGroup: '10T4', name: 'Nguyễn Thành Nhân', dob: '01/10/2008', gender: 'Nam',
  ...
  {
    stt: 32, classGroup: '10T4', name: 'Trần Tố Như', dob: '09/05/2011', gender: 'Nữ',
    cccd: '091311002605', issueDate: '02/06/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp 8', curWard: 'Xã Giồng Riềng, An Giang',
    permHam: 'Ấp 8', permWard: 'Xã Giồng Riềng, An Giang',
    birthPlace: 'Giồng Riềng, Tỉnh Kiên Giang', birthWard: 'Xã Giồng Riềng, An Giang',
    homeTown: 'Xã Giồng Riềng, Tỉnh An Giang', homeWard: 'Xã Giồng Riềng, An Giang',
  ...
  {
    stt: 33, classGroup: '10T4', name: 'Lương Bảo Như', dob: '18/02/2011', gender: 'Nữ',
  ...
  {
    stt: 34, classGroup: '10T4', name: 'Vũ Trần Nguyệt Như', dob: '08/07/2011', gender: 'Nữ',
    cccd: '091311006094', issueDate: '11/08/2025', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp 6', curWard: 'Xã Giồng Riềng, An Giang',
    permHam: 'Ấp 6', permWard: 'Xã Giồng Riềng, An Giang',
    birthPlace: 'Phường III, Thành phố Vị Thanh, tỉnh Hậu Giang', birthWard: 'Phường Vị Thanh, TP. Cần Thơ',
  ...
  {
    stt: 35, classGroup: '10T4', name: 'Huỳnh Tấn Phát', dob: '29/05/2011', gender: 'Nam',
    cccd: '089211003426', issueDate: '29/07/2024', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp 6', curWard: 'Xã Giồng Riềng, An Giang',
  ...
  {
    stt: 36, classGroup: '10T4', name: 'Nguyễn Thị Cẩm Tiên', dob: '10/10/2011', gender: 'Nữ',
  ...
  {
    stt: 37, classGroup: '10T4', name: 'Nguyễn Trần Tuấn Tú', dob: '14/06/2011', gender: 'Nam',
  ...
  {
    stt: 38, classGroup: '10T4', name: 'Tôn Nghiêm Khánh Tường', dob: '13/12/2011', gender: 'Nam',
  ...
  {
    stt: 39, classGroup: '10T4', name: 'Lý Gia Thoại', dob: '26/04/2011', gender: 'Nam',
    cccd: '091211009947', issueDate: '12/05/2025', ethnicity: 'Hoa', religion: 'Phật',
    curHam: 'Ấp Nguyễn Hưởng', curWard: 'Xã Long Thạnh, An Giang',
    permHam: 'Ấp Nguyễn Hưởng', permWard: 'Xã Long Thạnh, An Giang',
    birthPlace: 'Xã Vĩnh Thạnh, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Long Thạnh, An Giang',
    homeTown: 'Ấp Nguyễn Hưởng, Xã Long Thạnh, An Giang', homeWard: 'Xã Long Thạnh, An Giang',
  ...
  {
    stt: 40, classGroup: '10T4', name: 'Ngô Minh Thuận', dob: '03/10/2011', gender: 'Nam',
  ...
  {
    stt: 41, classGroup: '10T4', name: 'Ngô Diễm Thuý', dob: '16/04/2011', gender: 'Nữ',
    ...
    birthPlace: 'Xã Thạnh Lộc, Huyện Giồng Riềng, Kiên Giang', birthWard: 'Xã Thạnh Hưng, An Giang',
  ...
  {
    stt: 42, classGroup: '10T4', name: 'Nguyễn Minh Trí', dob: '23/07/2011', gender: 'Nam',
    ...
    birthPlace: 'Bệnh Viện Giồng Riềng Xã Ngọc Chúc Tỉnh An Giang', birthWard: 'Xã Ngọc Chúc, An Giang',
  ...
  {
    stt: 43, classGroup: '10T4', name: 'Lê Văn Vinh', dob: '18/07/2011', gender: 'Nam',
    cccd: '091211012385', issueDate: '14/01/2026', ethnicity: 'Kinh', religion: 'Không',
    curHam: 'Ấp Tà Ke', curWard: 'Xã Giồng Riềng, An Giang',
    permHam: 'Ấp Tà Ke', permWard: 'Xã Giồng Riềng, An Giang',
    birthPlace: 'Ấp Tà Ke, Xã Giồng Riềng, Tỉnh An Giang', birthWard: 'Xã Giồng Riềng, An Giang',
  ...
  {
    stt: 44, classGroup: '10T4', name: 'Ngô Phương Vy', dob: '30/03/2011', gender: 'Nữ',
  ...
  {
    stt: 45, classGroup: '10T4', name: 'Lê Yến Vy', dob: '20/11/2011', gender: 'Nữ',
    ...
    birthPlace: 'Xã Giồng Riềng, An Giang', birthWard: 'Xã Giồng Riềng, An Giang',
  ...
  {
    stt: 46, classGroup: '10T4', name: 'Nguyễn Thị Thảo Vy', dob: '12/09/2011', gender: 'Nữ',
  ...
  {
    stt: 47, classGroup: '10T4', name: 'Trần Ngọc Yến', dob: '04/01/2011', gender: 'Nữ',
...
export const STUDENTS_DATA: StudentRecord[] = rawStudents.map((r) => {
  ...
  return {
    ...
    birthPlace: {
      detail: r.birthPlace?.trim() || 'Theo giấy khai sinh',
      ward: r.birthWard?.trim() || 'Xã, tỉnh theo địa chỉ mới',
      province: 'An Giang',
    },
    hometown: {
      detail: r.homeTown?.trim() || 'Đang cập nhật',
      ward: r.homeWard?.trim() || 'Xã, tỉnh theo địa chỉ mới',
      province: 'An Giang',
    },
  idCard: {
    number: r.cccd,
